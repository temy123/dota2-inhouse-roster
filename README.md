...
- 네 항목(밸런스, 팀 플레이, 전체 소감, 추가·수정 사항) 중 의견이 있는 항목만 작성하면 됩니다. 한 항목만 작성해도 전송할 수 있으며, 항목별 최대 4,000자·줄바꿈·이모지·특수문자를 허용합니다.
- 전송 중 네트워크가 일시적으로 끊기면 자동으로 최대 3회 재시도합니다. 전송 전 작성 내용은 이 기기의 브라우저에 임시 보관되어, 실패하거나 새로고침해도 다시 불러올 수 있습니다.
